...
<div class="container">
    <div class="col-lg-offset-3 col-md-offset-3 col-sm-offset-2 col-xs-offset-1">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-10 ">
            ...
            <h2>Have a Bank Account First At Arch Bank Inc.</h2>
            <p> To have a account in Arch bank web site you need to have a Saving account in Arch bank.To get more details Contac our customer care</p>
            <br>
            <br>
