...
<div class="container">
    <div class="col-lg-offset-3 col-md-offset-3 col-sm-offset-2 col-xs-offset-1">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-10 ">
            ...
            <h2> Account Details Update  Completed Successfully</h2>
            <p> All the updates are added.You will not be able to revert the update details.But you can Re update details  </p>
            <br>
            <br>
            <a  href="login.jsp" class=" btn btn-lg btn-primary " style="width:30%">Login</a>
